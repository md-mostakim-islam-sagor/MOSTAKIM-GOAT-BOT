...
module.exports = async (api) => {
        ...
        app.get("/stats", async (req, res) => {
                let fcaVersion;
                try {
                        fcaVersion = require("@mostakim-v2/fca-unofficial/package.json").version;
                }
                catch (e) {
                        fcaVersion = "unknown";
                }
                ...
                let threatStats = { violations: 0, bans: 0, trackedThreads: 0, bannedThreads: 0 };
                try {
                        const SpamTracker = require("../mostakim-v2/func/spamTracker.js");
                        if (global.GoatBot?.spamTracker?.getStats)
                                threatStats = global.GoatBot.spamTracker.getStats();
                } catch {}
        ...
        if (config.serverUptime.socket.enable == true)
                require("../mostakim-v2/bot/login/socketIO.js")(server);
};
