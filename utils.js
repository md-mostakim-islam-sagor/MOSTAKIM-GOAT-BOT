...
const { isHexColor, colors } = require("./mostakim-v2/func/colors.js");
const Prism = require("./mostakim-v2/func/prism.js");
...
const utils = {
        ...
        getExtFromUrl,
        getPrefix,
        getText: require("./mostakim-v2/languages/makeFuncGetLangs.js"),
        getTime,
        getType,
        compareVersion,
        isHexColor,
        isNumber,
        jsonStringifyColor,
        loading: require("./mostakim-v2/logger/loading.js"),
        log,
        logColor: require("./mostakim-v2/logger/logColor.js"),
        message,
        randomString,
        randomNumber,
        removeHomeDir,
